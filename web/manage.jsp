                ...
                <div class="container">
                    <div class="row">
                        <div class="text-center fh5co-heading animate-box">
                            <h2>All Product</h2>
                            <a href="add" class="btn btn-primary btn-outline">Add product</a>
                        </div>
                    </div>

                    <c:forEach items="${rs}" var="p">
                        <div class="col-md-3 fh5co-item-wrap">
                            <div class="fh5co-item animate-box">
                                <img src="${p.getImages()}" class="img-responsive">
                                <h3>${p.getName()}</h3>
                                <span class="fh5co-price">$${p.getPrice()}</span>
                                <p>${p.getDescription()}</p>
                                <a href="loadproduct?pid=${p.getId()}" class="btn btn-primary btn-outline">Update</a>
                                <a href="delete?pid=${p.getId()}" class="btn btn-primary btn-outline">Delete</a>
                            </div>
                        </div>
