                ...
                <div class="container">
                    ...
                    <div class="col-md-6 col-md-push-3 col-sm-6 col-sm-push-3">
                        ...
                        <c:forEach items="${rs}" var="a">
                            <form action="updateaccount" id="form-wrap" method="post">
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>ID</label>
                                        <input value="${a.getUid()}" type="text" name="id" class="form-control" id="name" readonly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>Email</label>
                                        <input value="${a.getEmail()}" type="text" name="email" class="form-control" id="name">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>Password</label>
                                        <input value="${a.getPassword()}" type="password" name="password" class="form-control" id="people">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>Name</label>
                                        <input value="${a.getName()}" type="text" name="name" class="form-control"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>Phone</label>
                                        <input value="${a.getPhonenumber()}" type="text" name="phone" class="form-control"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
