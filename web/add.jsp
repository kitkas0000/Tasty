            ...
            <div id="fh5co-featured-menu" class="fh5co-section">
                <div class="container">
                    ...
                    <div class="col-md-6 col-md-push-3 col-sm-6 col-sm-push-3">
                        ...
                        %>
                        <form action="add" id="form-wrap" method="post">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label for="many">Image Link</label>
                                    <input type="text" name="image" class="form-control" id="people">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label for="taskdatetime">Price</label>
                                    <input type="text" name="price" class="form-control"/>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label for="taskdatetime">Title</label>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input type="submit" class="btn btn-primary btn-outline btn-lg" value="Add">
                                </div>
                            </div>
                            <%= mess %>
                        </form>
