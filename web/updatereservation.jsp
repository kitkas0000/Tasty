                ...
                <div class="container">
                    ...
                    <div class="col-md-6 col-md-push-3 col-sm-6 col-sm-push-3">
                        ...
                        <c:forEach items="${rs}" var="r">
                            <form action="updatereservation" id="form-wrap" method="post">
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>ID</label>
                                        <input value="${r.getId()}" type="text" name="id" class="form-control" id="name" readonly>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label>Name</label>
                                        <input value="${r.getName()}" type="text" name="name" class="form-control" id="name">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label for="many">People Amount</label>
                                        <input value="${r.getNumberofpeople()}" type="text" name="people" class="form-control" id="people">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label for="taskdatetime">When</label>
                                        <input value="${r.getDate()}" type="text" name="date" id="taskdatetime" class="form-control"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
