                        ...
                        <form id="form-wrap">
                            <div class="row form-group">
                                <c:forEach items="${rs}" var="p">
                                    <div class="col-md-12">
                                        <label for="many">Name: ${p.getName()}</label>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="many">People Amount: ${p.getNumberofpeople()}</label>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="many">Time: ${p.getDate()}</label>
                                    </div>
                                    <div class="col-md-12">
                                        <a href="loadreservation?rid=${p.getId()}" class="btn btn-primary btn-outline">Update</a>
                                        <a href="deletereservation?rid=${p.getId()}" class="btn btn-primary btn-outline">Delete</a>
                                    </div>
                                </c:forEach>
                            </div>
                        </form>
